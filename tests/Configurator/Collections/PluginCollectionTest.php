...
/**
* @covers akmaljp\DriveMaru\Configurator\Collections\PluginCollection
*/
class PluginCollectionTest extends Test
{
	...
	*/
	public function testLoad()
	{
		...
		$this->assertInstanceOf(
			'akmaljp\\DriveMaru\\Plugins\\HTMLElements\\Configurator',
	...
	* @expectedExceptionMessage Class 'akmaljp\DriveMaru\Plugins\Unknown\Configurator
	*/
	...
	* @expectedExceptionMessage PluginCollection::normalizeValue() expects a class name or an object that implements akmaljp\DriveMaru\Plugins\ConfiguratorBase
	*/
	...
	*/
	...
	{
		$plugin = new \akmaljp\DriveMaru\Plugins\Autolink\Configurator($this->configurator);
		$this->configurator->plugins->add('Foo', $plugin);

		$this->assertArrayMatches(
			[
				'Foo' => [
					'className' => 'akmaljp\\DriveMaru\\Plugins\\Autolink\\Parser'
				]
			],
			$this->configurator->plugins->asConfig()
		);
