...
use akmaljp\DriveMaru\Configurator\Collections\NormalizedList;
use akmaljp\DriveMaru\Tests\Test;

/**
* @covers akmaljp\DriveMaru\Configurator\Collections\NormalizedList
*/
class NormalizedListTest extends Test
{
	...
	*/
	...
	{
		$mock = $this->getMockBuilder('akmaljp\\DriveMaru\\Configurator\\Collections\\NormalizedList')
		             ->setMethods(['append'])
		             ->getMock();
