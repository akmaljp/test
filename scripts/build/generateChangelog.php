...
{
	echo "**\xE2\x9A\xA0\xEF\xB8\x8F This release contains API changes. See [docs/Internals/API_changes.md](http://akmaljpDriveMaru.readthedocs.io/Internals/API_changes/#" . preg_replace('(\\D)', '', $newVersion) . ") for a description. \xE2\x9A\xA0\xEF\xB8\x8F**\n\n";
}

echo "[Full commit log](https://github.com/akmaljp/DriveMaru/compare/$oldCommitId...$newCommitId)\n";
