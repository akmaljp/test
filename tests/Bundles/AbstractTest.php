...
namespace akmaljp\DriveMaru\Tests\Bundles;

use akmaljp\DriveMaru\Tests\Test;

/**
* @covers akmaljp\DriveMaru\Bundle
*/
abstract class AbstractTest extends Test
{
	...
	protected static function getClassName()
	{
		...
		return 'akmaljp\\DriveMaru\\Bundles\\' . $bundleName;
	}
	...
	/**
	* @testdox getCachedParser() returns an instance of akmaljp\DriveMaru\Parser
	*/
	public function testGetCachedParser()
	{
		$className = static::getClassName();
		$this->assertInstanceOf(
			'akmaljp\\DriveMaru\\Parser',
			$className::getCachedParser()
		);
	}

	/**
	* @testdox getCachedParser() returns the same instance of akmaljp\DriveMaru\Parser
	*/
	...
	/**
	* @testdox getParser() returns an instance of akmaljp\DriveMaru\Parser
	*/
	...
	/**
	* @testdox getParser() returns a new instance of akmaljp\DriveMaru\Parser
	*/
	...
	/**
	* @testdox getCachedRenderer() returns an instance of akmaljp\DriveMaru\Renderer
	*/
	...
	/**
	* @testdox getCachedRenderer() returns the same instance of akmaljp\DriveMaru\Renderer
	*/
	...
	/**
	* @testdox getRenderer() returns an instance of akmaljp\DriveMaru\Renderer
	*/
	...
	/**
	* @testdox getRenderer() returns a new instance of akmaljp\DriveMaru\Renderer
	*/
