...
<head>
	<meta charset="utf-8" />
	<title>akmaljp\DriveMaru &bull; Scroller Demo</title>
	<base href="https://akmaljp.github.io/DriveMaru/scroller.html" />
	<style type="text/css">
		#preview
		{
			font-family: sans;
...
The parser/renderer used on this page has been generated by [this script](https://github.com/akmaljp/DriveMaru/blob/master/scripts/generateScrollerDemo.php). It's been minified with Google Closure Compiler to <?php printf('%.1f', strlen($js) / 1024); ?> KB (<?php printf('%.1f', strlen(gzcompress($js, 9)) / 1024); ?> KB compressed)
</textarea>
		</form>
	</div>
	...
	<script type="text/javascript"><?php echo $js; ?>;
		...
		setInterval(function()
		{
			...
			var lastUpdated = akmaljp.DriveMaru.preview(textarea.value, preview);
...
file_put_contents(__DIR__ . '/../../akmaljp.github.io/DriveMaru/scroller.html', ob_get_clean());
