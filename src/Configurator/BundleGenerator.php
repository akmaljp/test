...
class BundleGenerator
{
	...
	*/
	public function generate($className, array $options = [])
	{
		...
		$php = [];
		$php[] = '/**';
		$php[] = '* @package   akmaljp\DriveMaru';
		$php[] = '* @copyright Copyright (c) 2010-2019 The akmaljp Authors';
		...
		$php[] = 'abstract class ' . $className . ' extends \\akmaljp\\DriveMaru\\Bundle';
		$php[] = '{';
		$php[] = '	/**';
		$php[] = '	* @var akmaljp\\DriveMaru\\Parser Singleton instance used by parse()';
		$php[] = '	*/';
		$php[] = '	protected static $parser;';
		$php[] = '';
		$php[] = '	/**';
		$php[] = '	* @var akmaljp\\DriveMaru\\Renderer Singleton instance used by render()';
		$php[] = '	*/';
		...
		$php[] = '	/**';
		$php[] = '	* Return a new instance of akmaljp\\DriveMaru\\Parser';
		$php[] = '	*';
		$php[] = '	* @return akmaljp\\DriveMaru\\Parser';
		$php[] = '	*/';
		...
		$php[] = '';
		$php[] = '	/**';
		$php[] = '	* Return a new instance of akmaljp\\DriveMaru\\Renderer';
		$php[] = '	*';
		$php[] = '	* @return akmaljp\\DriveMaru\\Renderer';
		$php[] = '	*/';
