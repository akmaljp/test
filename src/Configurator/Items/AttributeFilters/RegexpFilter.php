...
use akmaljp\DriveMaru\Configurator\Helpers\ContextSafeness;
use akmaljp\DriveMaru\Configurator\Helpers\RegexpParser;
...
class RegexpFilter extends AttributeFilter
{
	...
	*/
	...
	{
		parent::__construct('akmaljp\\DriveMaru\\Parser\\AttributeFilters\\RegexpFilter::filter');
