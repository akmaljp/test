...
use Exception;
use stdClass;
use akmaljp\DriveMaru\Configurator\Collections\NormalizedCollection;
use akmaljp\DriveMaru\Tests\Test;

/**
* @covers akmaljp\DriveMaru\Configurator\Collections\NormalizedCollection
*/
class NormalizedCollectionTest extends Test
{
	protected function getMockCollection()
	{
		return $this->getMockBuilder('akmaljp\\DriveMaru\\Configurator\\Collections\\NormalizedCollection')->setMethods(func_get_args())->getMock();
	}
