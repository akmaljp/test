...
/**
* @covers akmaljp\DriveMaru\Configurator\Items\AttributeFilters\MapFilter
*/
class MapFilterTest extends Test
{
	/**
	* @testdox Callback is akmaljp\DriveMaru\Parser\AttributeFilters\MapFilter::filter()
	*/
	public function testCallback()
	{
		...
		$this->assertSame(
			'akmaljp\\DriveMaru\\Parser\\AttributeFilters\\MapFilter::filter',
			$filter->getCallback()
		);
	}
	...
	*/
	...
	{
		$className = 'akmaljp\\DriveMaru\\Configurator\\Items\\AttributeFilters\\MapFilter';
