...
/**
* @covers akmaljp\DriveMaru\Configurator\Items\Tag
*/
class TagTest extends Test
{
	...
	*/
	public function testSetTemplate()
	{
		...
		$this->assertAttributeInstanceOf(
			'akmaljp\\DriveMaru\\Configurator\\Items\\Template',
			'template',
			$tag
		);
	}
	...
	*/
	...
	{
		$callback = 'akmaljp\\DriveMaru\\Parser\\FilterProcessing::filterAttributes';
