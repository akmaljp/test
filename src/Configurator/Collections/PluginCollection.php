...
class PluginCollection extends NormalizedCollection
{
	...
	*/
	public function normalizeValue($value)
	{
		...
		throw new InvalidArgumentException('PluginCollection::normalizeValue() expects a class name or an object that implements akmaljp\\DriveMaru\\Plugins\\ConfiguratorBase');
	}
	...
	*/
	public function load($pluginName, array $overrideProps = [])
	{
		...
		$className  = 'akmaljp\\DriveMaru\\Plugins\\' . $pluginName . '\\Configurator';
	...
	*/
	public function asConfig()
	{
		...
		foreach ($plugins as $pluginName => &$pluginConfig)
		{
			...
			$className = 'akmaljp\\DriveMaru\\Plugins\\' . $pluginName . '\\Parser';
