...
use akmaljp\DriveMaru\Configurator\Items\DynamicTemplateParameter;
use akmaljp\DriveMaru\Configurator\Items\UnsafeTemplate;
use akmaljp\DriveMaru\Configurator\RendererGenerators\PHP;
use akmaljp\DriveMaru\Tests\Plugins\BBCodes\BBCodesTest;
use akmaljp\DriveMaru\Tests\Test;

/**
* @covers akmaljp\DriveMaru\Configurator\RendererGenerators\PHP
* @covers akmaljp\DriveMaru\Configurator\RendererGenerators\PHP\Serializer
	...
	*/
	...
	public function getEdgeCases()
	{
		return [
			...
			[
				'<r xmlns:html="urn:akmaljp:DriveMaru:html"><html:b>...</html:b></r>',
				function ($configurator)
				{
...
!!!!		',
			...
			[
				...
				function ($configurator)
				{
					$configurator->tags->add('X')->template = '<div data-akmaljp-livepreview-ignore-attrs="foo"/>';
				}
			],
			[
				'<r><X/></r>',
	...
	* @dataProvider getPluginsTests
	* @requires extension tokenizer
	* @covers akmaljp\DriveMaru\Configurator\RendererGenerators\PHP\Quick
	*/
	...
	public function getPluginsTests()
	{
		...
		foreach (glob($pluginsDir . '/*', GLOB_ONLYDIR) as $dirpath)
		{
			...
			$className  = 'akmaljp\\DriveMaru\\Tests\\Plugins\\' . $pluginName . '\\ParserTest';
