...
/**
* @covers akmaljp\DriveMaru\Configurator\Collections\AttributeCollection
*/
class AttributeCollectionTest extends Test
{
	/**
	* @testdox add() returns an instance of akmaljp\DriveMaru\Configurator\Items\Attribute
	*/
	public function testAddNormalizeValue()
	{
		...
		$this->assertInstanceOf(
			'akmaljp\\DriveMaru\\Configurator\\Items\\Attribute',
			$collection->add('x')
		);
	}
