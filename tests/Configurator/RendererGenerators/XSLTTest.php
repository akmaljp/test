...
* @covers akmaljp\DriveMaru\Configurator\RendererGenerators\XSLT
*/
class XSLTTest extends Test
{
	...
	*/
	public function testDeclaresNamespaces()
	{
		...
		$this->assertContains(
			'xmlns:X="urn:akmaljp:DriveMaru:X" xmlns:Y="urn:akmaljp:DriveMaru:Y"',
			$this->getXSL()
		);
	}
	...
	*/
	...
	{
		$this->configurator->tags->add('X')->template = '<hr data-akmaljp-livepreview-ignore-attrs="foo"/>';
