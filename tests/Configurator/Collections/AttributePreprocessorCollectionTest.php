...
/**
* @covers akmaljp\DriveMaru\Configurator\Collections\AttributePreprocessorCollection
*/
class AttributePreprocessorCollectionTest extends Test
{
	/**
	* @testdox add() returns an instance of akmaljp\DriveMaru\Configurator\Items\AttributePreprocessor
	*/
	public function testClassName()
	{
		...
		$this->assertInstanceOf(
			'akmaljp\\DriveMaru\\Configurator\\Items\\AttributePreprocessor',
			$collection->add('x', '#x#')
		);
	}
