...
/**
* @covers akmaljp\DriveMaru\Configurator\Items\ProgrammableCallback
*/
class ProgrammableCallbackTest extends Test
{
	...
	* @expectedExceptionMessage akmaljp\DriveMaru\Configurator\Items\ProgrammableCallback::__construct() expects a callback
	*/
	...
	*/
	public function testAsConfigJavaScript()
	{
		...
		$this->assertInstanceOf(
			'akmaljp\\DriveMaru\\Configurator\\JavaScript\\Code',
			$config['js']
		);
