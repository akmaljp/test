...
$configurator = akmaljp\DriveMaru\Configurator\Bundles\Fatdown::getConfigurator();
...
<head>
	<meta charset="utf-8" />
	<title>akmaljp\DriveMaru &bull; Fatdown/JS Demo</title>
	<base href="https://akmaljp.github.io/DriveMaru/fatdown.html" />
	<style type="text/css">
		#preview
		{
			font-family: sans;
...
<body>
 ...
 - **PipeTables** --- ASCII-style tables are supported. See [its syntax](http://akmaljpDriveMaru.readthedocs.io/Plugins/PipeTables/Syntax/)

***

The parser/renderer used on this page has been generated by [this script](https://github.com/akmaljp/DriveMaru/blob/master/scripts/generateFatdownDemo.php). It's been minified with Google Closure Compiler to <?php printf('%.1f', strlen($js) / 1024); ?> KB (<?php printf('%.1f', strlen(gzcompress($js, 9)) / 1024); ?> KB compressed)</textarea>
		</form>
	</div>
	...
	<script type="text/javascript"><?php echo $js; ?>;
		...
		setInterval(function()
		{
			...
			akmaljp.DriveMaru.preview(text, previewEl);
		}, 20);

		function toggle(el)
		{
			(el.checked) ? akmaljp.DriveMaru.enablePlugin(el.id)
			             : akmaljp.DriveMaru.disablePlugin(el.id);
...
file_put_contents(__DIR__ . '/../../akmaljp.github.io/DriveMaru/fatdown.html', ob_get_clean());
