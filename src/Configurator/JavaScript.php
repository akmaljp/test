...
use akmaljp\DriveMaru\Configurator\JavaScript\RegexpConvertor;
use akmaljp\DriveMaru\Configurator\JavaScript\StylesheetCompressor;
use akmaljp\DriveMaru\Configurator\RendererGenerators\XSLT;
...
class JavaScript
{
	...
	*/
	...
	/**
	* @var array (Deprecated) List of methods to be exported in the akmaljp.DriveMaru object
	*/
	public $exportMethods;

	/**
	* @var array List of methods and properties to be exported in the akmaljp.DriveMaru object
	*/
	public $exports = [
		'disablePlugin',
		'disableTag',
	...
	*/
	public function getParser(array $config = null)
	{
		...
		$src .= "if (!window['akmaljp']) window['akmaljp'] = {};\n" . $this->getExports();
	...
	*/
	protected function getExports()
	{
		...
		return "window['akmaljp']['DriveMaru'] = {" . implode(',', $exports) . '}';
	}
