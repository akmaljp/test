...
use Exception;
use akmaljp\DriveMaru\Configurator\JavaScript\Minifiers\FirstAvailable;
use akmaljp\DriveMaru\Tests\Test;

/**
* @covers akmaljp\DriveMaru\Configurator\JavaScript\Minifiers\FirstAvailable
*/
class FirstAvailableTest extends Test
{
	...
	*/
	...
	{
		$minifier1 = $this->getMockBuilder('akmaljp\\DriveMaru\\Configurator\\JavaScript\\Minifier')
		                  ->getMock();
		$minifier2 = $this->getMockBuilder('akmaljp\\DriveMaru\\Configurator\\JavaScript\\Minifier')
		                  ->getMock();
