...
/**
* @covers akmaljp\DriveMaru\Plugins\MediaEmbed\Configurator
*/
class ConfiguratorTest extends Test
{
	...
	*/
	public function testAddReturn()
	{
		$this->assertInstanceOf(
			'akmaljp\\DriveMaru\\Configurator\\Items\\Tag',
			$this->configurator->MediaEmbed->add('youtube')
		);
	}
	...
	*/
	public function testAddIframe()
	{
		...
		$this->assertEquals(
			'<span data-akmaljp-mediaembed="youtube" style="display:inline-block;width:100%;max-width:800px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:56.25%"><iframe allowfullscreen="" scrolling="no" src="foo" style="border:0;height:100%;left:0;position:absolute;width:100%"/></span></span>',
			$tag->template
		);
	}
	...
	*/
	public function testAddFlash()
	{
		...
		$this->assertEquals(
			'<span data-akmaljp-mediaembed="youtube" style="display:inline-block;width:100%;max-width:800px"><span style="display:block;overflow:hidden;position:relative;padding-bottom:56.25%"><object data="foo" style="height:100%;left:0;position:absolute;width:100%" type="application/x-shockwave-flash" typemustmatch=""><param name="allowfullscreen" value="true"/></object></span></span>',
			$tag->template
		);
	}
