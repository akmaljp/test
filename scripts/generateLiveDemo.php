...
<head>
	<meta charset="utf-8" />
	<title>akmaljp\DriveMaru &bull; Demo</title>
	<base href="https://akmaljp.github.io/DriveMaru/demo.html" />
	<style type="text/css">
		#preview
		{
			font-family: sans;
...
This is a demo of the JavaScript port of [url=https://github.com/akmaljp/DriveMaru/tree/master/src/ title="akmaljp\DriveMaru at GitHub.com"]akmaljp\DriveMaru[/url].
...
The parser/renderer used on this page has been generated by [url=https://github.com/akmaljp/DriveMaru/blob/master/scripts/generateLiveDemo.php]this script[/url]. It's been minified with Google Closure Compiler to <?php printf('%.1f', strlen($js) / 1024); ?> KB (<?php printf('%.1f', strlen(gzcompress($js, 9)) / 1024); ?> KB compressed)</textarea>
		</form>
	</div>
...
file_put_contents(__DIR__ . '/../../akmaljp.github.io/DriveMaru/demo.html', ob_get_clean());
