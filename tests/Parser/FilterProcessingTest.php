...
use akmaljp\DriveMaru\Configurator\Items\Tag as TagConfig;
use akmaljp\DriveMaru\Parser;
use akmaljp\DriveMaru\Parser\FilterProcessing;
use akmaljp\DriveMaru\Parser\Logger;
use akmaljp\DriveMaru\Parser\Tag;
use akmaljp\DriveMaru\Tests\Test;

/**
* @covers akmaljp\DriveMaru\Parser\FilterProcessing
*/
class FilterProcessingTest extends Test
{
	...
	*/
	...
	{
		$tag = $this->getMockBuilder('akmaljp\\DriveMaru\\Parser\\Tag')
	...
	*/
	public function testFilterTagCallsLoggerSetTag()
	{
		...
		$logger = $this->getMockBuilder('akmaljp\\DriveMaru\\Parser\\Logger')
		...
		$parser = $this->getMockBuilder('akmaljp\\DriveMaru\\Parser')
		               ->disableOriginalConstructor()
