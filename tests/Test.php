...
abstract class Test extends \PHPUnit_Framework_TestCase
{
	...
	protected function execJS($src, $input)
	{
		...
		$src = file_get_contents(__DIR__ . '/browserStub.js') . $src . ';' . $function . '(window.akmaljp.DriveMaru.parse(' . json_encode($input) . '))';
	...
	{
		$filepath = sys_get_temp_dir() . '/akmaljp_' . uniqid() . '.tmp';
