...
class AttributeFilterCollection extends NormalizedCollection
{
	...
	*
	* @param  string $key
	* @return \akmaljp\DriveMaru\Configurator\Items\ProgrammableCallback
	*/
	...
	*/
	public static function getDefaultFilter($filterName)
	{
		...
		$className  = 'akmaljp\\DriveMaru\\Configurator\\Items\\AttributeFilters\\' . $filterName . 'Filter';
	...
	*/
	public function normalizeValue($value)
	{
		...
		throw new InvalidArgumentException('Argument 1 passed to ' . __METHOD__ . ' must be a valid callback or an instance of akmaljp\\DriveMaru\\Configurator\\Items\\AttributeFilter');
	}
}