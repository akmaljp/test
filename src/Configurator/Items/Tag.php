...
use akmaljp\DriveMaru\Configurator\Collections\AttributeCollection;
use akmaljp\DriveMaru\Configurator\Collections\AttributePreprocessorCollection;
use akmaljp\DriveMaru\Configurator\Collections\Ruleset;
...
class Tag implements ConfigProvider
{
	...
	*/
	public function __construct(array $options = null)
	{
		...
		$this->filterChain->append('akmaljp\\DriveMaru\\Parser\\FilterProcessing::executeAttributePreprocessors')
		                  ->addParameterByName('tagConfig')
		                  ->setJS('executeAttributePreprocessors');

		$this->filterChain->append('akmaljp\\DriveMaru\\Parser\\FilterProcessing::filterAttributes')
		                  ->addParameterByName('tagConfig')
	...
	*/
	public function asConfig()
	{
		...
		{
			$callback = 'akmaljp\\DriveMaru\\Parser\\FilterProcessing::executeAttributePreprocessors';
