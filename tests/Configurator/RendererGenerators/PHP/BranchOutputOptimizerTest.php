...
use akmaljp\DriveMaru\Configurator\RendererGenerators\PHP\BranchOutputOptimizer;
use akmaljp\DriveMaru\Tests\Test;

/**
* @requires extension tokenizer
* @covers akmaljp\DriveMaru\Configurator\RendererGenerators\PHP\BranchOutputOptimizer
*/
